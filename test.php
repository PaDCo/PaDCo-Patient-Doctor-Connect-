...
<a href="chat.php ">Chat</a>
    ...
    <div id="container">
      ...
      <form method="POST">
      	 <input type="text" id="mydoc" name="docsname" value="">
      	 <input type="submit" name="but_test" id='but_test_id'>
      </form>
      <?php
      ...
      <?php
        ...
        if(isset($_POST['submit'])){
          ...
          $message = $_POST['msg'];
          $docname1 = $_POST['test'];
          echo "<script>alert($docname1)</script>";
